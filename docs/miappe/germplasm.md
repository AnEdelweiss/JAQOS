...
- **rdf_type** : you currently have the choice between Species and Varieties (**vocabulary:Species** or **vocabulary:Variety**( **Warning : this is case sensitive** )). Please declare all the species that will be used by the varieties before declaring varieties.

Following the example below:

![Germ ex 1](miappe_images/germplasm_ex1.png)
...
>{: .highlight }
>You can refer to the 'read me' sheet to fill all the germplasms specific informations.
>This example is a bare minimum.

![good Germ](miappe_images/germplasm.png)