...
class TestCLI:
    ...
    @patch("simple.cli.check_connection_internet")
    def test_main_exit_option_9(
        self, mock_check_net, mock_int_prompt, mock_prompt, mock_connexion
    ):
        """
    ...
    @patch("simple.cli.IntPrompt.ask")
    @patch("simple.cli.check_connection_internet")
    def test_main_catches_simple_base_exception(
        self,
        mock_check_net,
        mock_int_prompt,
        mock_prompt,
    ...
    @patch("simple.cli.IntPrompt.ask")
    @patch("simple.cli.check_connection_internet")
    def test_main_submenu_experiment_creation(
        self,
        mock_check_net,
        mock_int_prompt,
        mock_prompt,
        ...
        mock_ui_create.assert_called_once_with("miappe.xlsx", ANY)
